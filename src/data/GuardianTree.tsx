export const GuardianTree = (xOffset: number, yOffset: number) => [
	{
		id: 'root',
		name: 'Root',
		currentLevel: 0,
	...
	{
		id: 'ignore_pierce_3_2',
		name: 'Ignore_Pierce_3_2',
		currentLevel: 0,
		levelTiers: [
			{ minLevel: 0, maxLevel: 20,
				requiredPrerequisiteLevel:  [{
	...
	{
		id: 'ignore_pierce_1_2',
		name: 'Ignore_Pierce_1_2',
		currentLevel: 0,
		levelTiers: [
			{ minLevel: 0, maxLevel: 20,
				requiredPrerequisiteLevel:  [{
	...
	{
		id: 'skill_critical_2_2',
		name: 'Skill_Crit_Hit_2_2',
		currentLevel: 0,
		levelTiers: [
			{ minLevel: 0, maxLevel: 20,
				requiredPrerequisiteLevel:  [{
